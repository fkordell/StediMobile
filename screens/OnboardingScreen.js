        ...
        pages={[
            {
              ...
              subtitle: (
                <View>
                  <Text style={{fontWeight:'bold', textAlign:'center', color:'#A0CE4E', fontSize:20, margin:12,  marginTop: -40}}>We value your privacy. Pleae share your phone number so we can track your balance.</Text>
                </View>
              ),
            },
            {
